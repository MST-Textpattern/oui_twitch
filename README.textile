...
"oui_player_twitch":https://github.com/NicolasGraph/oui_player_twitch is a "oui_player":https://github.com/NicolasGraph/oui_player v2+ extension to easily embed "Twitch":https://twitch.go.com/ provided videos in "Textpattern":https://textpattern.com/ powered websites.
...
h3. oui_if_twitch vs oui_if_player

p. While the @<txp:oui_if_player>…</txp:oui_if_player>@ tag is able to check an URL against any URL from any extension-related provider, the @<txp:oui_if_twitch>…</txp:oui_if_twitch>@ tag is a shortcut to check an URL against Twitch related URL schemes only. It is strictly equivalent to @<txp:oui_if_player provider="twitch">…</txp:oui_if_player>@.
...
"oui_player":https://github.com/NicolasGraph/oui_player preference related field value: @https://www.twitch.tv/videos/264624894@.

h3. Embed a player by defining its provider and a media ID through attributes

bc(language-markup). <txp:oui_player provider="twitch" play="264624894" />

…or:

bc(language-markup). <txp:oui_twitch play="264624894" />

h3. Conditionally embed a player using attributes

bc(language-markup).. <txp:oui_if_player provider="twitch" play="https://www.twitch.tv/solaris">
    <txp:oui_player />
</txp:oui_if_player>

p. …or:

bc(language-markup).. <txp:oui_if_twitch play="https://www.twitch.tv/solaris">
    <txp:oui_twitch />
</txp:oui_if_twitch>
...
oui_player_twitch version 1.0.0, Copyright (C) 2018 Nicolas Morand
...
* *oui_player_twitch v1.0.0-beta* (2018-06-24)
